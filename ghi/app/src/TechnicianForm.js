        ...
        <div className="row">
            ...
            <div className="shadow p-4 mt-4">
                ...
                <div className="form-floating mb-3">
                    <input onChange={handleNameChange} value={technicianName} placeholder="Technician Name" required name="technician_name" id="technician_name" className="form-control" />
