                ...
                <div className="offset-3 col-6">
                    <div className="shadow p-4 mt-4">
                        ...
                        <form onSubmit={this.handleSubmit} id="create-salesperson-form">
                            ...
                            <div className="form-floating mb-3">
                                <input onChange={this.handleChange} value={this.state.employeeNumber} placeholder="Employee Number" required type="number" name="employeeNumber" id="employeeNumber" className="form-control" />
